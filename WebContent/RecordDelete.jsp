...
<body>
	...
	<form action="RecordDeleteCheck.jsp" method="post">
		<div class="container top-space container text-center">
			<h1>献血記録削除</h1>
			<br>
			<br> 削除したい回：<input type="text" name="textTimes" size=5
				maxlength="2" /><br>
			<br> <button type="submit" class="btn btn-default button-set2">この回を削除</button>
		</div>
	</form>
